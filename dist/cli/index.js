...
program
    ...
    .option('--framework <type>', 'Framework (react|next)', 'react')
    .option('--i18n <library>', 'i18n library (next-intl|react-i18next)', 'react-i18next')
    ...
    for (const file of files) {
        try {
            ...
            const result = transformer({ source, path: file }, { jscodeshift: jscodeshift.withParser('tsx'), stats: () => { } }, { ...options, existingMessages });
